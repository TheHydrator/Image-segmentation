# -*- coding: utf-8 -*-
"""image segmentation(project).ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1cuO5sCJaPblznfmZlnc4dL9t4DQ8dnbD
"""
...
# Pickle is primarily used in serializing and deserializing a Python object structure. It also transport data over the network.
...
# NLTK helps the computer to analyze, preprocess, and understand the written text. It also helps in sentimental analysis.
...
coco=COCO("/content/drive/MyDrive/annotations_trainval2017/instances_train2017.json")
...
annFile = "/content/drive/MyDrive/annotations_trainval2017/person_keypoints_train2017.json"
...
annFile = "/content/drive/MyDrive/annotations_trainval2017/captions_train2017.json"
...
from keras.layers import InputLayer, Activation, add,Concatenate,Input
...
img_paths = ["/content/in-traffic_signal.jpg",
            "/content/playing football.jpg",
            "/content/tennis_play.jpg",
            "/content/test_image.jpg",
            "/content/test_image2.jpg"]
...
#max_length = 46
model = load_model('/content/drive/MyDrive/annotations_trainval2017/model/model_0(image_caption_generator).h5')
